...
const config: AppConfig = {
  ...
  hostname: process.env.WEBPODS_TEST_HOSTNAME as string,
  ...
  */
  tiers: [
    {
      ...
      maxSpaceMB: 64,
      claims: {
        iss: "https://" + (process.env.WEBPODS_TEST_HOSTNAME as string) + "/",
        plan: "free",
      },
    },
    {
  ...
  storage: {
    ...
    */
    dataDir: process.env.WEBPODS_TEST_DATA_DIR as string,
